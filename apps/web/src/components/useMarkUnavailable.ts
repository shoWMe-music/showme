...
// Re-exported so every existing importer keeps its path: the arithmetic moved
// out to be testable, not to be relocated for callers.
export { type UnavailabilityBlock, applyDaySelection, collapseDays };

/** Who may write unavailability — an authorization question, not range maths. */
