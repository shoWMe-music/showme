...
function generateSeedEvents(): Event[] {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    events.push({
      id: `EVT-G${String(i + 1).padStart(3, "0")}`,
      name: `${baseName}${suffix}`,
      date: dateStr,
      venue: venue.name,
      operator: venue.operator,
      operatorType: venue.opType,
      ticketingProvider: venue.provider,
      capacity: venue.cap,
      artist,
      eventStatus,
...
export const seedContacts: Contact[] = [
  ...
  { id: "P-009", name: "Aurora", type: "artist", contacts: [{ name: "Aurora Aksnes", email: "mgmt@aurora-music.com", phone: "+47 555 0101" }], iban: "NO9386011117947", bankName: "DNB", vatId: "", address: "Bergen, Norway", notes: "" },
  { id: "P-010", name: "GoGo Penguin", type: "artist", contacts: [{ name: "Chris Illingworth", email: "info@gogopenguin.co.uk", phone: "+44 161 555 0101" }], iban: "GB29NWBK60161331926819", bankName: "NatWest", vatId: "", address: "Manchester, UK", notes: "" },
  { id: "P-011", name: "Moderat", type: "artist", contacts: [{ name: "Sascha Ring", email: "booking@moderat.fm", phone: "+49 30 555 0101" }], iban: "DE89370400440532013000", bankName: "Commerzbank", vatId: "", address: "Berlin, Germany", notes: "" },
  { id: "P-012", name: "Fontaines D.C.", type: "artist", contacts: [{ name: "Grian Chatten", email: "info@fontainesdc.com", phone: "+353 1 555 0101" }], iban: "IE29AIBK93115212345678", bankName: "AIB", vatId: "", address: "Dublin, Ireland", notes: "" },
  { id: "P-013", name: "Bonobo", type: "artist", contacts: [{ name: "Simon Green", email: "mgmt@bonobomusic.com", phone: "+44 20 555 0102" }], iban: "GB29NWBK60161331926820", bankName: "NatWest", vatId: "", address: "London, UK", notes: "" },
  { id: "P-023", name: "José González", type: "artist", contacts: [{ name: "José González", email: "info@josegonzalez.com", phone: "+46 31 555 0101" }], iban: "SE3550000000054910000003", bankName: "SEB", vatId: "", address: "Gothenburg, Sweden", notes: "" },
  { id: "P-024", name: "Noisia", type: "artist", contacts: [{ name: "Thijs de Vlieger", email: "booking@noisia.nl", phone: "+31 50 555 0101" }], iban: "NL39RABO0300065280", bankName: "Rabobank", vatId: "NL567890123B01", address: "Groningen, Netherlands", notes: "" },
  { id: "P-025", name: "Caribou", type: "artist", contacts: [{ name: "Dan Snaith", email: "mgmt@caribouband.com", phone: "+44 20 555 0601" }], iban: "GB82WEST12345698765450", bankName: "HSBC", vatId: "", address: "London, UK", notes: "" },
  { id: "P-026", name: "Islandman", type: "artist", contacts: [{ name: "Tolga Boyuk", email: "info@islandmanmusic.com", phone: "+90 212 555 0101" }], iban: "TR330006100519786457841326", bankName: "Garanti BBVA", vatId: "", address: "Istanbul, Turkey", notes: "" },
  { id: "P-027", name: "Khruangbin", type: "artist", contacts: [{ name: "Mark Speer", email: "booking@khruangbin.com", phone: "+1 713 555 0101" }], iban: "US98765432101234567890", bankName: "Bank of America", vatId: "", address: "Houston, TX, USA", notes: "" },
